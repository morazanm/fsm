...
The following: (B) are not valid lowercase alphabet letters in the given input alphabet: (a B)"))
  ...
  (check-error (make-cfg '(S)
                         ...
                         `((S ,ARROW ,EMP)
                           (S ,ARROW aSb))
                         'S)
               (format "Step one of the design recipe has not been sucessfully completed. The following values, (b), are duplicated in the given sigma: (a b b)"))
...
The given grammar nonterminals must be a list: A"))
  ...
  (check-error (make-cfg '(S)
                         ...
                         `((S ,ARROW ,EMP)
                           ...
                           (S ,ARROW aSb))
                         'S)
               (format "Step three of the design recipe has not been sucessfully completed. The following values, ((S -> aSb)), are duplicated in the given rules: ((S -> ε) (S -> aSb) (S -> aSb))"))
