#lang racket/base
(module+ test
  (require "../../../fsm-core/private/urg-constructors.rkt"
           "../../../fsm-core/private/constants.rkt"
           rackunit)

  ; Context Sensitive Grammars
  (define anbn (make-grammar '(S A B)
                         '(a b)
                         `((S ,ARROW AAaAAB)
                           (AAaAAA ,ARROW aSb)
                           (AAaAAA ,ARROW ,EMP)
  ...
  (check-exn #rx"Step two of the design recipe has not been successfully completed.
The given nonterminals must be a list: S"
             (lambda () (make-grammar 'S
                                      '(a b)
                                      `((S ,ARROW AAaAAB)
                                        (AAaAAA ,ARROW aSb)
                                        (AAaAAA ,ARROW ,EMP)
...
The following starting state, C, is not in the given list of states: \\(S A B\\)"
  ...
  (check-exn
   #rx"Step four of the design recipe has not been successfully completed.
