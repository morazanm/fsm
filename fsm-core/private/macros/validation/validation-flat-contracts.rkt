     ...
     #:projection (lambda (blame)
                    (lambda (words)
                      ...
                      (raise-blame-error
                       ...
                       (format "Step six of the design recipe has not been successfully completed. The following words in the ~a list contain symbols not included in sigma" field)
                       )
                      )
                    )
     )
