...
#;(list
 (treelist
  (ndfa-config 'K '(c g c g a t a t g c t a g c a t) 0)
  (ndfa-config 'D '(g c g a t a t g c t a g c a t) 1)
  (ndfa-config 'B '(c g a t a t g c t a g c a t) 2)
  (ndfa-config 'D '(g a t a t g c t a g c a t) 3)
  (ndfa-config 'B '(a t a t g c t a g c a t) 4)
  (ndfa-config 'H '(t a t g c t a g c a t) 5)
  (ndfa-config 'F '(a t g c t a g c a t) 6)
  (ndfa-config 'H '(t g c t a g c a t) 7)
  (ndfa-config 'F '(g c t a g c a t) 8)
  (ndfa-config 'S '(c t a g c a t) 9)
  (ndfa-config 'R '(t a g c a t) 10)
  (ndfa-config 'M '(a g c a t) 11)
  (ndfa-config 'I '(g c a t) 12)
  (ndfa-config 'S '(c a t) 13)
  (ndfa-config 'R '(a t) 14)
  (ndfa-config 'H '(t) 15)
  (ndfa-config 'F '() 16)))

#;(list
 (list
  (trace (ndfa-config 'K '(c g c g a t a t g c t a g c a t) 0) (list (rule (triple 'K 'c 'D))))
  (trace (ndfa-config 'D '(g c g a t a t g c t a g c a t) 1) (list (rule (triple 'D 'g 'B))))
  (trace (ndfa-config 'B '(c g a t a t g c t a g c a t) 2) (list (rule (triple 'B 'c 'D))))
  (trace (ndfa-config 'D '(g a t a t g c t a g c a t) 3) (list (rule (triple 'D 'g 'B))))
  (trace (ndfa-config 'B '(a t a t g c t a g c a t) 4) (list (rule (triple 'B 'a 'H))))
  (trace (ndfa-config 'H '(t a t g c t a g c a t) 5) (list (rule (triple 'H 't 'F))))
  (trace (ndfa-config 'F '(a t g c t a g c a t) 6) (list (rule (triple 'F 'a 'H))))
  (trace (ndfa-config 'H '(t g c t a g c a t) 7) (list (rule (triple 'H 't 'F))))
  (trace (ndfa-config 'F '(g c t a g c a t) 8) (list (rule (triple 'F 'g 'S))))
  (trace (ndfa-config 'S '(c t a g c a t) 9) (list (rule (triple 'S 'c 'R))))
  (trace (ndfa-config 'R '(t a g c a t) 10) (list (rule (triple 'R 't 'M))))
  (trace (ndfa-config 'M '(a g c a t) 11) (list (rule (triple 'M 'a 'I))))
  (trace (ndfa-config 'I '(g c a t) 12) (list (rule (triple 'I 'g 'S))))
  (trace (ndfa-config 'S '(c a t) 13) (list (rule (triple 'S 'c 'R))))
  (trace (ndfa-config 'R '(a t) 14) (list (rule (triple 'R 'a 'H))))
  (trace (ndfa-config 'H '(t) 15) (list (rule (triple 'H 't 'F))))
  (trace (ndfa-config 'F '() 16) (list (rule (triple 'ε 'ε 'ε))))))

#;(list
 (list (ndfa-config 'K '() 0) #t)
 (list (ndfa-config 'D '(c) 1) #t)
 (list (ndfa-config 'B '(c g) 2) #t)
 (list (ndfa-config 'D '(c g c) 3) #t)
 (list (ndfa-config 'B '(c g c g) 4) #t)
 (list (ndfa-config 'H '(c g c g a) 5) #f)
 (list (ndfa-config 'F '(c g c g a t) 6) #t)
 (list (ndfa-config 'H '(c g c g a t a) 7) #f)
 (list (ndfa-config 'F '(c g c g a t a t) 8) #t)
 (list (ndfa-config 'S '(c g c g a t a t g) 9) #t)
 (list (ndfa-config 'R '(c g c g a t a t g c) 10) #t)
 (list (ndfa-config 'M '(c g c g a t a t g c t) 11) #t)
 (list (ndfa-config 'I '(c g c g a t a t g c t a) 12) #t)
 (list (ndfa-config 'S '(c g c g a t a t g c t a g) 13) #t)
 (list (ndfa-config 'R '(c g c g a t a t g c t a g c) 14) #t)
 (list (ndfa-config 'H '(c g c g a t a t g c t a g c a) 15) #f)
 (list (ndfa-config 'F '(c g c g a t a t g c t a g c a t) 16) #t))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
