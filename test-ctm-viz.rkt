...
;(define ADDM (eval ADD2L))
;(displayln ADDM)
;(define ADD2 (combine-tms ADDM '(d)))

;(displayln (eval '(cons 1 (cons 2 (cons 3 empty)))))
;(displayln (eval (list 1 2 3)))
...
;(ctm-viz ADD2 ADD2L `(,LM ,BLANK ,BLANK ,BLANK ,BLANK) 1)
;(ctm-viz ADD2 ADD2L `(,LM ,BLANK ,BLANK ,BLANK d d d ,BLANK) 1)
;(ctm-viz ADD2 ADD2L `(,LM ,BLANK d d d) 1)