...
@defproc[(sm-test-invs [m machine?] [#:rep-limit rep-limit natural? 1] [#:max-path-length path-length natural? 12] [#:ds-remove-fsa ds-remove-fsa #t] [#:ds-remove-pda ds-remove-pda #f] [invs (list state (-> word boolean))] ...)
