(module dfa-tests racket
  ...
  (check-error (make-dfa 'A
                          ...
                          `((A b C)
                            (A c C)
                            (B c B)
                            (B a B))) (format "Step three of the design recipe has not be succesfully completed.
The given machine states must be a list: A"))
  ...
  (check-error (make-dfa '(A B C 1)
                          ...
                          `((A b C)
                            (A c C)
                            (B c B)
                            (B a B))) (format "Step three of the design recipe was not successfully completed.
...
The following: (a b) are not valid machine states in the given list of machine states: (A B C a b)"))
  ...
  (check-error (make-dfa '(A B C A)
                          ...
                          `((A b C)
                            (A c C)
                            (B c B)
                            (B a B))) (format "Step three of the design recipe has not been sucessfully completed.
...
There following values, (A B), are duplicated in the given states:  (A B B C A A)"))
  ...
  (check-error (make-dfa '(A B C D)
                          ...
                          `((A b C)
                            (A c D)
                            (B c D)
                            (B a B))) (format "Step one of the design recipe was not successfully completed.
...
The following: (A B) are not valid lowercase alphabet letters in the given input alphabet: (a b c A B)"))
  ...
  (check-error (make-dfa '(A B C D)
                          ...
                          `((A b C)
                            (A c D)
                            (B c D)
                            (B a B))) (format "Step one of the design recipe has not been sucessfully completed.
...
The following: (a b) are not valid machine states in the given list of machine finals: (B C a b)"))
  ...
  (check-error (make-dfa '(A B C D)
                          ...
                          `((A b C)
                            (A c D)
                            (B c D)
                            (B a B))) (format "Step three of the design recipe has not been successfully completed.
...
The following starting state, F, is not in the given list of states: (A B C D)"))
  ...
  (check-error (make-dfa '(A B C D)
                          ...
                          'A
                          '(B C)
                          'A) (format "Step four of the design recipe has not be succesfully completed.
The given machine rules must be a list: A"))
  ...
  (check-error (make-dfa '(A B C D)
                          ...
                          'A
                          '(B C)
                          '(A)) (format "Step four of the design recipe was not successfully completed.
