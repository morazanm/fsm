...
(define IPF-RULE1-TM (textbox 40 25 INPUT-COLOR INPUT-COLOR "" 4 (posn (- WIDTH 135) (- (* 5 CONTROL-BOX-H) 80)) #f))
(define IPF-RULE2-TM (textbox 40 25 INPUT-COLOR INPUT-COLOR "" 4 (posn (- WIDTH 65) (- (* 5 CONTROL-BOX-H) 80)) #f))
(define IPF-RULE3-TM (textbox 40 25 INPUT-COLOR INPUT-COLOR "" 4 (posn (- WIDTH 135) (- (* 5 CONTROL-BOX-H) 52)) #f))
(define IPF-RULE4-TM (textbox 40 25 INPUT-COLOR INPUT-COLOR "" 4 (posn (- WIDTH 65) (- (* 5 CONTROL-BOX-H) 52)) #f))
