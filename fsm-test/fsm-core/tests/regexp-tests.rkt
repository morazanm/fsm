(module regexp-tests racket
  ...
  (check-error
   ...
   "The argument to singleton-regexp must be a single digit, a single Roman alphabet character, $, &, !, or *, but found: \"abc\"")
  (check-error
   (singleton-regexp 5)
   "The argument to singleton-regexp must be a single digit, a single Roman alphabet character, $, &, !, or *, but found: 5")
  #;(check-error
   (singleton-regexp "A")
   "The argument to singleton-regexp must be a single digit or Roman alphabet character, but found: \"A\"")
  (check-error
   (singleton-regexp "/")
   "The argument to singleton-regexp must be a single digit, a single Roman alphabet character, $, &, !, or *, but found: \"/\"")
