...
(check-equal? (cadr (sm-apply ww `(,LM ,BLANK b b b b) 1))
              `(10 (,LM ,BLANK b b b b b b b b ,BLANK)))
(check-equal? (cadr (sm-apply ww `(,LM ,BLANK a b a b a b b) 1))
              `(16 (,LM ,BLANK a b a b a b b a b a b a b b ,BLANK)))
