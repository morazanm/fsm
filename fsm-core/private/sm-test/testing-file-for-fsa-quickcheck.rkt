#lang fsm
(require "sm-quickcheck.rkt"
         "reg-exp-function.rkt"
         ;"state-machine-function.rkt"
         ;"sm-test-invs-fsa-fail.rkt"
         "sm-test-invs-fsa.rkt"
         ; "new-new-regexp.rkt"
         ;"../../interface.rkt"
         racket/list
         rackunit)
...
(define (E2-INV ci) (contains-aabab? ci))   ;<- not broken
...
(define a+b+c+a+b+ (make-dfa '(S A B C D E)
                             '(a b c)
                             'S
                             '(E)
                             '((S a A)
...
(define contains-abca (make-dfa '(S A B C D)
                                '(a b c)
                                'S
                                '(D)
                                '((S a A)
...
(define big-container (make-ndfa '(S A B C D E F H I)
                                 '(u n e a r
                                     ;c l d i g o
                                     )
                                 'S
...
(for ([x (in-naturals)]
 ...
 (time (sm-quickcheck DNA-SEQUENCE
...
(for ([x (in-naturals)]
 ...
 (time (sm-quickcheck no-contain-bababa (list (list 'S S-INV-no-contain-bababa)
                            (list 'A A-INV-no-contain-bababa)
                            (list 'B B-INV-no-contain-bababa)
                            (list 'C C-INV-no-contain-bababa)
                            (list 'D D-INV-no-contain-bababa)
...
(for ([x (in-naturals)]
 ...
 (time (sm-quickcheck AT-LEAST-ONE-MISSING  (list (list 'S S-INV-AT-LEAST-ONE-MISSING)
                                       (list 'A A-INV-AT-LEAST-ONE-MISSING)
                                       (list 'B B-INV-AT-LEAST-ONE-MISSING)
                                       (list 'C C-INV-AT-LEAST-ONE-MISSING)))))
"lots-of-kleenes"
(for ([x (in-naturals)]
 ...
 (time (sm-quickcheck lots-of-kleenes (list (list 'S S-INV-lots-of-kleenes)
...
(for ([x (in-naturals)]
 ...
 (time (sm-quickcheck ONE-LETTER-MISSING (list (list 'S S-INV-1-MISSING)
...
(for ([x (in-naturals)]
 ...
 (time (sm-quickcheck ab*b*Uab* (list (list 'A A-INV-ab*b*Uab*) (list 'B B-INV-ab*b*Uab*) (list 'C C-INV-ab*b*Uab*)
                            (list 'D D-INV-ab*b*Uab*) (list 'E E-INV-ab*b*Uab*) (list 'S S-INV-ab*b*Uab*)))))
"M3"
(for ([x (in-naturals)]
      #:break (= x 51))
 
 (time (sm-quickcheck M3 (list (list 'S S3-INV)
                     (list 'A A3-INV)
                     (list 'B B3-INV)
                     (list 'C C3-INV)
                     (list 'D D3-INV)
...
(for ([x (in-naturals)]
 ...
 (time (sm-quickcheck a+b+c+a+b+ (list (list 'S INVS=T)
                             (list 'A INVS=T)
                             (list 'B INVS=T)
                             (list 'C INVS=T)
                             (list 'D INVS=T)
...
(for ([x (in-naturals)]
 ...
 (time (sm-quickcheck CONTAINS-aabab (list (list 'S S2-INV) (list 'A A2-INV)
...
(for ([x (in-naturals)]
 ...
 (time (sm-quickcheck (make-ndfa '(S A B C D E)
                             '(a b c)
                             'S
                             '(E)
                             '((S a A)
...
(define tests (list
               (test-case 'big-container
                          ...
                          (lambda () (sm-quickcheck big-container
                                                    LOI-big-container)))
               (test-case 'mini-monster-kaboom
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck mini-monster-kaboom
                                                    LOI-mini-monster-kaboom)))

               (test-case 'evil-dna-sequence
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck EVIL-dna-sequence
                                                    (list (list 'K DNA-K-INV)
                                                          (list 'H DNA-H-INV)
                                                          (list 'F DNA-F-INV)
                                                          (list 'M DNA-M-INV)
               ...
               (test-case 'dna-sequence
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck DNA-SEQUENCE
                                                    (list (list 'K DNA-K-INV)
                                                          (list 'H DNA-H-INV)
                                                          (list 'F DNA-F-INV)
                                                          (list 'M DNA-M-INV)
               ...
               (test-case 'no-contain-bababa
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck no-contain-bababa (list (list 'S S-INV-no-contain-bababa)
                                                                            (list 'A A-INV-no-contain-bababa)
                                                                            (list 'B B-INV-no-contain-bababa)
                                                                            (list 'C C-INV-no-contain-bababa)
                                                                            (list 'D D-INV-no-contain-bababa)
               ...
               (test-case 'AT-LEAST-ONE-MISSING
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck AT-LEAST-ONE-MISSING  (list (list 'S S-INV-AT-LEAST-ONE-MISSING)
                                                                                (list 'A A-INV-AT-LEAST-ONE-MISSING)
                                                                                (list 'B B-INV-AT-LEAST-ONE-MISSING)
                                                                                (list 'C C-INV-AT-LEAST-ONE-MISSING)))))
               (test-case 'lots-of-kleenes
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck lots-of-kleenes (list (list 'S S-INV-lots-of-kleenes)
                                                                          (list 'A A-INV-lots-of-kleenes)
                                                                          (list 'B B-INV-lots-of-kleenes)
                                                                          (list 'C C-INV-lots-of-kleenes)
                                                                          (list 'D D-INV-lots-of-kleenes)
               ...
               (test-case 'ONE-LETTER-MISSING
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck ONE-LETTER-MISSING (list (list 'S S-INV-1-MISSING)
                                                                             (list 'A A-INV-1-MISSING)
                                                                             (list 'B B-INV-1-MISSING)
                                                                             (list 'C C-INV-1-MISSING)
                                                                             (list 'D D-INV-1-MISSING)
               ...
               (test-case 'ab*b*Uab*
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck ab*b*Uab* (list (list 'A A-INV-ab*b*Uab*) (list 'B B-INV-ab*b*Uab*) (list 'C C-INV-ab*b*Uab*)
                                                                    (list 'D D-INV-ab*b*Uab*) (list 'E E-INV-ab*b*Uab*) (list 'S S-INV-ab*b*Uab*)))))
               (test-case 'M3
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck M3 (list (list 'S S3-INV)
                                                             (list 'A A3-INV)
                                                             (list 'B B3-INV)
                                                             (list 'C C3-INV)
                                                             (list 'D D3-INV)
               ...
               (test-case 'a+b+c+a+b+
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck a+b+c+a+b+ (list (list 'S INVS=T)
                                                                     (list 'A INVS=T)
                                                                     (list 'B INVS=T)
                                                                     (list 'C INVS=T)
                                                                     (list 'D INVS=T)
               ...
               (test-case 'CONTAINS-aabab
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck CONTAINS-aabab (list (list 'S S2-INV) (list 'A A2-INV)
                                                                         (list 'B B2-INV) (list 'C C2-INV)
                                                                         (list 'D D2-INV) (list 'E E2-INV)))))
               (test-case 'a+b+c+a+b+ndfa
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck (make-ndfa '(S A B C D E)
                                                               '(a b c)
                                                               'S
                                                               '(E)
                                                               '((S a A)
               ...
               (test-case 'EVEN-NUM-Bs
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck EVEN-NUM-Bs
                                                    (list (list 'S EVEN-NUM-Bs-S-INV) (list 'F EVEN-NUM-Bs-F-INV)))))
               (test-case 'aa*Uab*
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck aa*Uab*
                                                    (list (list 'K  aa-ab-K-INV) (list 'B aa-ab-B-INV) (list 'D aa-ab-D-INV)))))
               (test-case 'EX-NDFA
                          NUM-TESTS-PER-MACHINE
                          (lambda () (sm-quickcheck EX-NDFA
                                                    (list (list 'S S-INV-EX-NDFA)
                                                          (list 'A A-INV-EX-NDFA)
                                                          (list 'B B-INV-EX-NDFA)
                                                          (list 'C C-INV-EX-NDFA)))))
...
(define (A-INV-grammar ci)
  #;(and (equal? (drop ci (- (length ci) 1)) '(a))    
       (not (contains? ci PROHIBITED-PATTERN)))
  (and (eq? (first ci) 'b)
       (not (contains? ci PROHIBITED-PATTERN))))

(define (B-INV-grammar ci)
  (and (not (contains? ci PROHIBITED-PATTERN))
       (or (eq? (first ci) 'b)
           (eq? (first ci) 'a))))
...
;(grammar-viz a+b+c+d '(a a a a a b b b b b b c c d) (list 'S S-INV-a+b+c+d) (list 'A A-INV-a+b+c+d) (list 'B B-INV-a+b+c+d) (list 'C C-INV-a+b+c+d))
