...
(begin-for-syntax
  ...
  (define-syntax (reposition-out-of-bounds-img stx)
    (syntax-parse stx
      [(_ a-vs viewport-lims new-img new-scale)
  ...
  (define-syntax (create-go-next stx)
    (syntax-parse stx 
      [(_ viz-state-struct E-SCENE-WIDTH E-SCENE-HEIGHT DEFAULT-ZOOM-CAP DEFAULT-ZOOM-FLOOR PERCENT-BORDER-GAP NODE-SIZE)
       #'(lambda (a-vs)
                 ...
                 (if (does-img-need-resizing? new-curr-img E-SCENE-WIDTH E-SCENE-HEIGHT)
                     (let [(NEW-FLOOR (min (second img-resize) (third img-resize)))]
                       (cond [(> (viz-state-scale-factor a-vs) DEFAULT-ZOOM-CAP)
                              (let [(new-viz-state (struct-copy viz-state-struct a-vs
                                                                [imgs new-imgs]
  ...
  (define-syntax (create-go-prev stx)
    ;E-SCENE-WIDTH E-SCENE-HEIGHT PERCENT-BORDER-GAP DEFAULT-ZOOM-CAP DEFAULT-ZOOM-FLOOR NODE-SIZE)
    (syntax-parse stx
      [(_ E-SCENE-WIDTH E-SCENE-HEIGHT DEFAULT-ZOOM-CAP DEFAULT-ZOOM-FLOOR PERCENT-BORDER-GAP NODE-SIZE)
       #'(lambda (a-vs)
  ...
  (define-syntax (create-go-to-begin stx)
    ;E-SCENE-WIDTH E-SCENE-HEIGHT PERCENT-BORDER-GAP DEFAULT-ZOOM-CAP DEFAULT-ZOOM-FLOOR NODE-SIZE)
    (syntax-parse stx
      [(_ E-SCENE-WIDTH E-SCENE-HEIGHT DEFAULT-ZOOM-CAP DEFAULT-ZOOM-FLOOR PERCENT-BORDER-GAP NODE-SIZE)
       #'(lambda (a-vs)
  ...
  (define-syntax (create-go-to-end stx)
    ;E-SCENE-WIDTH E-SCENE-HEIGHT PERCENT-BORDER-GAP DEFAULT-ZOOM-CAP DEFAULT-ZOOM-FLOOR NODE-SIZE)
    (syntax-parse stx
      [(_ E-SCENE-WIDTH E-SCENE-HEIGHT DEFAULT-ZOOM-CAP DEFAULT-ZOOM-FLOOR PERCENT-BORDER-GAP NODE-SIZE)
       #'(lambda (a-vs)
  ...
  (define (zoom a-vs factor E-SCENE-WIDTH E-SCENE-HEIGHT NODE-SIZE ZOOM-INCREASE ZOOM-DECREASE)
...
#;(define-syntax (create-go-next stx)
    (syntax-parse stx 
      [(_ E-SCENE-WIDTH E-SCENE-HEIGHT DEFAULT-ZOOM-CAP DEFAULT-ZOOM-FLOOR PERCENT-BORDER-GAP)
       (with-syntax ([go-next (datum->syntax stx 'go-next)])
         #'(define (go-next a-vs)
             (if (zipper-at-end? (viz-state-imgs a-vs))
                 a-vs
                 (let* [(new-imgs (zipper-next (viz-state-imgs a-vs)))
...
#;(define-syntax (create-go-prev stx)
    ...
    (syntax-parse stx
      [(_ E-SCENE-WIDTH E-SCENE-HEIGHT DEFAULT-ZOOM-CAP DEFAULT-ZOOM-FLOOR PERCENT-BORDER-GAP)
       (with-syntax ([go-prev (datum->syntax stx 'go-prev)])
         #'(define (go-prev a-vs)
             (if (zipper-at-begin? (viz-state-imgs a-vs))
                 a-vs
                 (let* [(new-imgs (zipper-prev (viz-state-imgs a-vs)))
...
#;(define-syntax (create-go-to-end stx)
    ...
    (syntax-parse stx
      [(_ E-SCENE-WIDTH E-SCENE-HEIGHT DEFAULT-ZOOM-CAP DEFAULT-ZOOM-FLOOR PERCENT-BORDER-GAP)
       (with-syntax ([go-to-end (datum->syntax stx 'go-to-end)])
...
(define-syntax (create-default-functions stx)
  ;(define go-next-stx #`#,(create-go-next #'E-SCENE-WIDTH #'E-SCENE-HEIGHT #'DEFAULT-ZOOM-CAP #'DEFAULT-ZOOM-FLOOR #'PERCENT-BORDER-GAP))
  (syntax-parse stx
    
    [(_ viz-state-struct E-SCENE-WIDTH E-SCENE-HEIGHT DEFAULT-ZOOM-CAP DEFAULT-ZOOM-FLOOR PERCENT-BORDER-GAP NODE-SIZE)
     (with-syntax ([go-next (datum->syntax stx 'go-next)]
                   [go-prev (datum->syntax stx 'go-prev)]
                   [go-to-begin (datum->syntax stx 'go-to-begin)]
                   [go-to-end (datum->syntax stx 'go-to-end)])
       #`(begin
           (define go-next #,(create-go-next #'viz-state-struct #'E-SCENE-WIDTH #'E-SCENE-HEIGHT #'DEFAULT-ZOOM-CAP #'DEFAULT-ZOOM-FLOOR #'PERCENT-BORDER-GAP #'NODE-SIZE))
           (define go-prev #,(create-go-prev #'viz-state-struct #'E-SCENE-WIDTH #'E-SCENE-HEIGHT #'DEFAULT-ZOOM-CAP #'DEFAULT-ZOOM-FLOOR #'PERCENT-BORDER-GAP #'NODE-SIZE))
           (define go-to-begin #,(create-go-to-begin #'viz-state-struct #'E-SCENE-WIDTH #'E-SCENE-HEIGHT #'DEFAULT-ZOOM-CAP #'DEFAULT-ZOOM-FLOOR #'PERCENT-BORDER-GAP #'NODE-SIZE))
           (define go-to-end #,(create-go-to-end #'viz-state-struct #'E-SCENE-WIDTH #'E-SCENE-HEIGHT #'DEFAULT-ZOOM-CAP #'DEFAULT-ZOOM-FLOOR #'PERCENT-BORDER-GAP #'NODE-SIZE))
           )
       )
     ]
    )
