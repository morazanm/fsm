...
@defproc[(make-dfsa [sts (listof state)] 
                    [sigma alphabet] 
                    [start state] 
                    [finals (listof state)] 
                    [delta (listof dfa-rule)])
         dfsa]{Builds a deterministic finite-state automaton. @italic{delta} is a transition function.}


@defproc[(make-ndfsa [sts (listof state)] 
                     [sigma alphabet] 
                     [start state] 
                     [finals (listof state)] 
                     [delta (listof ndfa-rule)])
         ndfsa]{Builds a nondeterministic finite-state automaton. @italic{delta} is a transition relation.}
...
@defproc[(make-tm    [sts (listof state)] 
                     ...
                     [delta (listof ndfa-rule)]
                     (accept state))
         ndfsa]{Builds a nondeterministic Turing machine. 
...
@defproc[(ndfa->dfa [m ndfsa])
         dfa]{Builds a @italic{deterministic} finite-state 
                       automaton for the language of the given ndfa.}

@defproc[(regexp->fsa [r regexp])
         ndfsa]{Builds a ndfsa for the language of the given
                regular expression.}
