...
(check-equal? (last (grammar-derive even-bs-odd-as '(a a a b b b b)))
              'aaabbbb)
(check-equal? (last (grammar-derive even-bs-odd-as '(b b b b b a a a b)))
              'bbbbbaaab)
(check-equal? (last (grammar-derive even-bs-odd-as '(a a b b b a b b a a b)))
              'aabbbabbaab)

(define even-bs-odd-as-chomsky (chomsky even-bs-odd-as))

(check-equal? (last (grammar-derive even-bs-odd-as-chomsky '(a a a b b b b)))
              'aaabbbb)
(check-equal? (last (grammar-derive even-bs-odd-as-chomsky '(b b b b b a a a b)))
              'bbbbbaaab)
(check-equal? (last (grammar-derive even-bs-odd-as-chomsky '(a a b b b a b b a a b)))
              'aabbbabbaab)

(define even-bs-odd-as-greibach (greibach even-bs-odd-as))

(check-equal? (last (grammar-derive even-bs-odd-as-greibach '(a a a b b b b)))
              'aaabbbb)
(check-equal? (last (grammar-derive even-bs-odd-as-greibach '(b b b b b a a a b)))
              'bbbbbaaab)
(check-equal? (last (grammar-derive even-bs-odd-as-greibach '(a a b b b a b b a a b)))
              'aabbbabbaab)
...
(check-equal? (last (grammar-derive anbncmdmejfj-chomsky2 '(a a a b b b))) 'aaabbb)
(check-equal? (last (grammar-derive anbncmdmejfj-chomsky2 '(a b c d e f))) 'abcdef)
(check-equal? (last (grammar-derive anbncmdmejfj-chomsky2 '(c c d d e f))) 'ccddef)
(check-equal?
...
(check-equal? (grammar-derive anbncmdmejfj-greibach2 '()) "The word () is too short to test.")
(check-equal? (last (grammar-derive anbncmdmejfj-greibach2 '(a a a b b b))) 'aaabbb)
(check-equal? (last (grammar-derive anbncmdmejfj-greibach2 '(a b c d e f))) 'abcdef)
(check-equal? (last (grammar-derive anbncmdmejfj-greibach2 '(c c d d e f))) 'ccddef)
(check-equal?
...
(check-equal? (grammar-derive anbncmdmejfj-greibach3 '()) "The word () is too short to test.")
(check-equal? (last (grammar-derive anbncmdmejfj-greibach3 '(a a a b b b))) 'aaabbb)
(check-equal? (last (grammar-derive anbncmdmejfj-greibach3 '(a b c d e f))) 'abcdef)
(check-equal? (last (grammar-derive anbncmdmejfj-greibach3 '(c c d d e f))) 'ccddef)
(check-equal?
