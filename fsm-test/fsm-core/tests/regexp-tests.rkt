...
The following words were expected to be generated by the constructed concat-regexp but were not generated: ((a a))")
  (check-error
   (concat-regexp singleton-a singleton-b #:not-in-lang '((a a) (a b)))
   "Step six of the design recipe for regular expressions has not been successfully completed.
The following words were expected to not be generated by the constructed concat-regexp but were generated: ((a b))")
  (check-error
   (concat-regexp singleton-a singleton-b #:in-lang '((a b) (a c)))
   "Step six of the design recipe for regular expressions has not been successfully completed.
The following words generated by the regular expression: ((a c)) contain characters not in the regular expression's alphabet: (a b)")
  (check-error
   (concat-regexp singleton-a singleton-b #:not-in-lang '((a a) (d e)))
   "Step six of the design recipe for regular expressions has not been successfully completed.
The following words not generated by the regular expression: ((d e)) contain characters not in the regular expression's alphabet: (a b)")
  (check-expect
...
The given predicate does not hold for the following words generated using the regexp: ((a))")
  (check-error
   ...
   "Step six of the design recipe for regular expressions has not been successfully completed.
The following words were expected to be generated by the constructed union-regexp but were not generated: ((a b))")
  (check-error
   (union-regexp singleton-a singleton-b #:not-in-lang '((a b) (b)))
   "Step six of the design recipe for regular expressions has not been successfully completed.
The following words were expected to not be generated by the constructed union-regexp but were generated: ((b))")
  (check-expect
  ...
  (check-error
   ...
   "Step six of the design recipe for regular expressions has not been successfully completed.
The following words generated by the regular expression: ((d e) (b c)) contain characters not in the regular expression's alphabet: (a b)")
  (check-error
   (union-regexp singleton-a singleton-b #:not-in-lang '((a) (b) (d e) (b c)))
   "Step six of the design recipe for regular expressions has not been successfully completed.
The following words not generated by the regular expression: ((d e) (b c)) contain characters not in the regular expression's alphabet: (a b)")
  (check-error
...
The given predicate does not hold for the following words generated using the regexp: (ε)")
  (check-error
   ...
   "Step six of the design recipe for regular expressions has not been successfully completed.
The following words were expected to not be generated by the constructed kleenestar-regexp but were generated: ((a) (a a))")
  (check-expect
  ...
  (check-error
   ...
   "Step six of the design recipe for regular expressions has not been successfully completed.
The following words generated by the regular expression: ((b) (d e) (b c)) contain characters not in the regular expression's alphabet: (a)")
  (check-error
   (kleenestar-regexp singleton-a #:not-in-lang '((a) (b) (d e) (b c)))
   "Step six of the design recipe for regular expressions has not been successfully completed.
The following words not generated by the regular expression: ((b) (d e) (b c)) contain characters not in the regular expression's alphabet: (a)")
  (check-error
