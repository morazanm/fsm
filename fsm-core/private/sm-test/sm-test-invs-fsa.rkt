...
(define (sm-test-invs-fsa a-machine rep-limit ds-remove a-loi)
  ...
  (define all-paths-new-machine (if ds-remove
                                    (filter-paths machine-paths new-states)  ;<- refactored
                                    machine-paths)) ;<- not refact
